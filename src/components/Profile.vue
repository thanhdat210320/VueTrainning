  ...
  <div class="pt-[40px]">
    <div class="flex">
      ...
      <div class="">
        ...
        <div class="flex text-[#FFFFFF] mt-[-20px]">
          <div class="bg-[#DD7A01] font-semibold text-[20px] mr-[20px] px-[20px] leading-[30px] rounded-[16px]">
            <button>VIP</button>
          </div>
          <div class="bg-[#0B8E11] font-semibold text-[20px] mr-[20px] px-[30px] leading-[30px] rounded-[16px]">
            <button>ACTIVE</button>
          </div>
          <div class="bg-[#FFDADA] text-[#DB524E] font-semibold text-[20px] leading-[30px] px-[30px] rounded-[16px]">
            <button>TPIN</button>
          </div>
        </div>
      </div>
